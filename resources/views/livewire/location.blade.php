            ...
            <div class="w-full h-full">
                <div
                    ...
                    <div class="flex relative flex-col p-6 w-full">
                        ...
                        <p class="mb-5 text-sm text-zinc-500 dark:text-gray-400">Silahkan masukkan data lokasi baru
                            dalam
                            formulir berikut untuk menambah data lokasi
                        </p>
                        <div class="flex items-center w-full">
                            <form wire:submit.prevent="storeLocation" class="space-y-6 w-full">
                                <!-- Input Component for Name -->
                                <x-ui.input label="Nama Lokasi" id="name" name="name" wire:model="name"
                                    class="w-full" />

                                <div class="flex gap-4">
                                    @if ($updateData == true)
                                        <x-ui.button wire:click="updateLocation()" type="primary" rounded="md"
            ...
            <div class="w-full h-full">
                <div
                    ...
                    <div class="flex relative flex-col p-4 w-full">
                        ...
                        @if ($locations->count())
                            <div class="relative border rounded-lg overflow-hidden dark:border-neutral-700">
                                            ...
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="py-3 px-6 flex  gap-2 items-center">
                                                        <x-ui.button wire:click="editLocation({{ $value->id }})"
                                                        ...
                                                        <x-ui.button wire:click="deleteLocation({{ $value->id }})"
                                                            type="warning" rounded="md" size="sm" submit="true"
                                                            width="sm">
                                                            <svg width="16" height="16" viewBox="0 0 16 16"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                        ...
                        @else
                            <p class="text-gray-500 dark:text-gray-400 text-sm">Tidak ada daftar lokasi</p>
                        @endif
                    </div>
                </div>
            </div>
