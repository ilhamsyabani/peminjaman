<div class="w-full h-full">
    ...
    <div class="flex  items-center justify-between w-full mb-4 py-4">
        ...
        <x-ui.input id="search" name="seach" wire:model.live="keyword" width="sm" placeholder="Search..." />
    </div>
            ...
            <div class="w-full h-full">
                <div
                    ...
                    <div class="flex relative flex-col p-6 w-full">
                        ...
                        <p class="mb-5 text-sm text-zinc-500 dark:text-gray-400">Silahkan masukkan data kategori baru
                            dalam
                            formulir berikut untuk menambah data kategori
                        </p>
                        <div class="flex items-center w-full">
                            <form wire:submit.prevent="store" class="space-y-6 w-full">
                                <!-- Input Component for Name -->
                                <x-ui.input label="Nama" id="name" name="name" wire:model="name"
                                    class="w-full" />
                                ...
                                <div class="flex gap-4">
                                    @if ($updateData == true)
                                        <x-ui.button wire:click="updateCategory()" type="primary" rounded="md"
                                    ...
                                    <tbody>
                                        @foreach ($categoris as $key => $value)
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td>
                                                    <div class="py-3 px-6 flex items-center">{{ $value->description }}
                                                    </div>
                                                </td>
                                                <td>

                                                    <div class="py-3 px-6 flex  gap-2 items-center">
                                                        <x-ui.button wire:click="editCategory({{ $value->id }})"
                                                            type="primary" rounded="md" size="sm" submit="true"
                                                            width="sm">
                                                        ...
                                                        <x-ui.button wire:click="deleteCategory({{ $value->id }})"
