            ...
            <div class="w-full h-full">
                <div
                    ...
                    <div class="flex relative flex-col p-6 w-full">
                        ...
                        <p class="mb-5 text-sm text-zinc-500 dark:text-gray-400">Silahkan masukan data ruangan baru
                            dalam
                            formulir berikut untuk menambah data ruangan
                        </p>
                        <div class="flex items-center w-full">
                            <form wire:submit.prevent="storeRoom" class="space-y-6 w-full">
                                <!-- Input Component for Name -->
                                <x-ui.select label="Lokasi ruangan" id="location_id" name="location_id"
                                    wire:model="location_id" placeholder="Pilih location" :options="$locations" />

                                <x-ui.input label="Nama Ruangan" id="name" name="name" wire:model="name"
                                    class="w-full" />

                                <div class="flex gap-4">
                                    @if ($updateData == true)
                                        <x-ui.button wire:click="updateRoom()" type="primary" rounded="md"
            ...
            <div class="w-full h-full">
                <div
                    ...
                    <div class="flex relative flex-col p-4 w-full">
                                            ...
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="py-3 px-6 flex  gap-2 items-center">
                                                        <x-ui.button wire:click="editRoom({{ $value->id }})"
                                                        ...
                                                        <x-ui.button wire:click="deleteRoom({{ $value->id }})"
                        ...
                        @else
                            <p class="text-gray-500 dark:text-gray-400 text-sm">Tidak ada daftar Ruangan</p>
                        @endif
                    </div>
                </div>
            </div>
