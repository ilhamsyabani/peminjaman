                ...
                <div
                    ...
                    <div class="flex relative flex-col p-6 w-full">
                        ...
                        <div class="flex items-center w-full">
                            <form wire:submit.prevent="storeItem" class="space-y-6 w-full"
                                ...
                                <span class=" text-slate-400 text-xs mb-4">*Tolong pastikan semua gambar yang terupload bersetatus hujau, karena tampilan akan hilang ketika memilih lokasi penyimpanan.</span>
                                ...
                                <p class="text-md mb-1">Informasi Penyimpanan</p>
                                <div
                                    class="grid grid-cols-1 md:grid-cols-2 gap-4 pb-8 border-b border-dotted border-zinc-200">
                                    <x-ui.select label="Jenis Penyimpanan" id="location_type" name="location_type"
                                        :options="['Location' => 'Lokasi', 'Room' => 'Ruang', 'Locker' => 'Loker']" wire:model.change="location_type" />
                                    @php
                                        $locationOptions = match ($location_type) {
                                            'Location' => \App\Models\Location::pluck('name', 'id')->toArray(),
                                            'Room' => \App\Models\Room::pluck('name', 'id')->toArray(),
                                            'Locker' => \App\Models\Locker::pluck('name', 'id')->toArray(),
                                            default => [],
                                        };
                                    @endphp
                                ...
                                <div class="mb-6">
                                    <x-ui.select label="Pembelian" id="purchase_id" name="purchase_id"
                                        wire:model="purchase_id" :options="$purcases" />
                                </div>
