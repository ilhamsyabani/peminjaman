                ...
                <div
                    ...
                    <div class="flex relative flex-col p-6 w-full">
                        <div
                            ...
                            <p class="mb-1 text-sm text-zinc-500 dark:text-gray-400">
                                Lengkapi informasi peminjam di bawah ini:
                            </p>
                        </div>

                        <div class="flex items-center w-full">
                            <div x-data="captureImage" class="container">
                                <p class="text-md text-zinc-500 dark:text-gray-400">Foto Peminjam</p>
                                <div id="oldPhoto">
                                    <img src="{{ asset('' . $borrower->photo) }}" alt="Foto Peminjam"
                                        class="rounded-md mb-4">
                                    <x-ui.button type="primary" rounded="md" width="auto" id="ambilUlang">
                                        Ambil ulang foto
                                    </x-ui.button>
                                </div>
                        ...
                        <form wire:submit.prevent="updateBorrower" class="space-y-6 w-[80%]"
                            ...
                            <x-ui.text-area label="Alamat" type="text" id="address" name="address"
                                wire:model="address" class="w-full"></x-ui.text-area>
                            <x-ui.text-area label="Informasi Lainnya" type="text" id="information"
                                name="information" wire:model="information" class="w-full"></x-ui.text-area>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('captureImage', () => ({
            ...
            init() {
                ...
                const changePhoto = document.getElementById('ambilUlang')
                ...
                captureButton.addEventListener('click', () => {
                    ...
                    output.innerHTML = '<p>Gambar ditangkap! Klik "Simpan".</p>';
                });
