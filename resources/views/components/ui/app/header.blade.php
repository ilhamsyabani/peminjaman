<header x-data="{ open: false }" class=" bg-white border-b border-gray-200/80 dark:bg-gray-900/40 dark:border-gray-200/[15%]">
    ...
    <div class="fixed w-screen z-10 bg-white border-b border-gray-200/80 dark:bg-gray-900/40 dark:border-gray-200/[15%]">
    <div class="px-4 mx-auto max-w-full sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 w-full">
            <!-- Logo -->
            <a href="{{ route('dashboard') }}" class=" ms-4 flex items-center shrink-0">
